---
layout: default
title: Tiaastor - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiaastor</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/TiaAstor" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
![Architecture Diagram](../assets/architecture/TiaAstor-architecture.svg)
...
```bash
# Build Docker image
docker build -t TiaAstor .

# Run container
docker run -p 8080:8080 TiaAstor
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/TiaAstor)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/TiaAstor/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/TiaAstor/discussions)
